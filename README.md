...
**一眼了解：** **54** 真实用户 · **六路**语义检索 · **三层**记忆 · **367** 单元测试 · **480+** 条人格数据 · **承诺记忆** · **会开口说话（GPT-SoVITS 语音）**
...
> 注：这几项是**阶段性累计快照**。记忆数据会在大的版本更新后清空重置（换新开局），
...
- **工程纪律**：367 个单元测试；方法论 + 踩坑记录持续沉淀进 ROADMAP，常驻速查在 CLAUDE.md。
